  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-multi-chooser :selections="versionList" @on-change="onParamChange('version', $event)"></v-multi-chooser>
        </div>
      </div>
      <div class="sales-board-line">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <div class="button" @click="showDialog">立即购买</div>
        </div>
      </div>
    </div>
    ...
    <my-dialog :is-show="isShowDialog" @close="closeDialog">
    ...
    <my-dialog :is-show-err-dialog="isShowErrDialog" @close="closeErrDialog">
      支付失败
    </my-dialog>
    <check-order :is-show-check-dialog="isShowCheckDialog" :orderId="orderId" @on-close-check-dialog="onCloseCheckDialog"></check-order>
  </div>
</template>
<script>
